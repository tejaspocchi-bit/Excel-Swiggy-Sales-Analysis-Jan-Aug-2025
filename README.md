...
🍽️ Swiggy Sales Analysis Dashboard (Jan–Aug 2025)
📊 Project Overview

This project presents an in-depth Sales Analysis of Swiggy across India from January 2025 to August 2025, built entirely using Microsoft Excel.
The dashboard provides a clear and interactive view of Swiggy’s business performance, customer behavior, and key revenue drivers.

The goal of this project is to transform raw food delivery data into actionable insights through advanced Excel techniques.
